...
### buscatch.jp (VISH株式会社) の利用規約

> 本サービスの全ての著作権はVISH株式会社または情報提供者にあり、
> **無断で転載・複写・蓄積・転送することはできません。**

- ✅ 個人がブラウザで閲覧する目的でのアクセス
- ✅ 45秒間隔×1人（通常閲覧と同等）
- ❌ 数据的蓄積・再配布・商用利用
- ❌ 高頻度アクセス（DoSとみなされる可能性）
